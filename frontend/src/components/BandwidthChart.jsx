  ...
  return (
    <div className="card-paper-white" style={{ padding: "24px" }}>
      <div style={{ marginBottom: 24 }}>
        ...
        >
          Token generation speeds scale with memory interfaces. Higher bandwidth
      ...
      <ResponsiveContainer width="100%" height={280}>
        ...
        >
          ...
          <Tooltip
            ...
            cursor={{ fill: "var(--color-parchment-cream)" }}
          />
