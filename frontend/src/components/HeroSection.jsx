        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ fontSize: "14px", color: "var(--color-ink-black)", fontWeight: "500", marginBottom: "12px" }}>
                How many nodes do we need to fit our <span className="pill-tag pill-tag-violet">@Q1 70B Model</span>?
              </div>
            </div>

            <div className="ai-prompt-container" onClick={onSearchOpen} style={{ cursor: "pointer" }}>
              <span className="ai-prompt-input" style={{ fontSize: "13px", color: "var(--color-ash-gray)" }}>
                Ask AI assistant...
              </span>
              <button className="ai-send-circle">
                →
              </button>
            </div>
          </div>
