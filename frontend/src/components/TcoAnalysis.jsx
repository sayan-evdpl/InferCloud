      ...
      <div className="section-container">
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <p className="subheading" style={{ maxWidth: "600px" }}>
            Buy vs Rent decision model configured for Indian enterprise compute
            markets (₹5L CapEx base, ₹7.50/kWh utility tariff, 1.3 PUE cooling
            factor).
          </p>
        </div>
            ...
            <div style={{ marginBottom: "28px" }}>
              ...
              >
                <label
                  ...
                  style={{ color: "var(--color-ink-black)", fontWeight: "600" }}
                >
                  DAILY RUNTIME
                </label>
                <span
            ...
            {data && (
              <div>
                ...
                >
                  ...
                  >
                    At 8 hours, CapEx amortizes nicely. Consider physical
                    hardware if data sovereignty is required.
                  </p>
                </div>
              </div>
            )}
            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height={360}>
                ...
                >
                  <CartesianGrid
                    strokeDasharray="3 3"
                    stroke="var(--color-sand-gray)"
                  />
                  <XAxis
                    dataKey="name"
                    tick={{
                      fill: "var(--color-charcoal-stone)",
                      fontSize: 12,
                      fontFamily: "var(--font-nunito-sans)",
                    }}
                    axisLine={false}
